...
import {CssBaseline , Paper, Stepper, Step , StepLabel, Typography,Button, CircularProgress, Divider} from "@material-ui/core";
...
const Checkout = ({cart, onCaptureCheckout}) => {
    ...
    const Confirmation = () =>(isFinished?(
        ...
        <div>
          ...
          <Typography variant="subtitle2">Order ref: zxvfwwh45</Typography>
        </div>
        <br />
